...
const PLAYER_SKILLS_TEXT_COLUMNS = [
  'name', 'indexName', 'description', 'descHeader', 'target', 'skillType',
  'upgradeLines', 'effectLines', 'duration', 'startTime', 'tickTime', 'cooldown',
  'cost', 'costTime', 'baseCost', 'baseMechanic', 'baseIsCostTime', 'chargeFreq',
  'minRange', 'maxRange', 'radius', 'isPassive', 'isChanneled', 'isPermanent',
  'isCrafted', 'craftedId', 'castTime', 'channelTime', 'angleDistance',
  'mechanic', 'mechanicTime', 'texture', 'isPlayer', 'raceType', 'classType',
  'setName', 'skillLine', 'prevSkill', 'nextSkill', 'nextSkill2',
  'baseAbilityId', 'learnedLevel', 'rank', 'morph', 'skillIndex', 'buffType',
  'isToggle', 'numCoefVars', 'coefDescription',
  'type1', 'a1', 'b1', 'c1', 'R1', 'avg1',
  'type2', 'a2', 'b2', 'c2', 'R2', 'avg2',
  'type3', 'a3', 'b3', 'c3', 'R3', 'avg3',
  'type4', 'a4', 'b4', 'c4', 'R4', 'avg4',
  'type5', 'a5', 'b5', 'c5', 'R5', 'avg5',
  'type6', 'a6', 'b6', 'c6', 'R6', 'avg6',
  'rawDescription', 'rawName', 'rawTooltip', 'rawCoef', 'coefTypes', 'isMastery',
] as const;

...
function portugueseTheme(): NavSidebar {
  return {
    ...
    sidebar: [
      ...
      // API content is English-only (generated by TypeDoc); it is mirrored
      // under /pt/api/ so the language switcher never lands on a 404.
      {
        text: 'API Reference (EN)',
        collapsed: true,
        items: [
          { text: 'Overview', link: '/pt/api/' },
          {
            text: 'Functions',
            collapsed: true,
            items: [
              { text: 'initEsoEngineFromData', link: '/pt/api/functions/initEsoEngineFromData' },
              { text: 'calculateBuild', link: '/pt/api/functions/calculateBuild' },
              { text: 'debugBuild', link: '/pt/api/functions/debugBuild' },
              ...
              {
                text: 'listAvailableToggleSkills',
                link: '/pt/api/functions/listAvailableToggleSkills',
              },
            ],
          },
          {
            ...
            collapsed: false,
            items: [
              { text: 'BuildInput', link: '/pt/api/interfaces/BuildInput' },
              { text: 'ComputedStats', link: '/pt/api/interfaces/ComputedStats' },
              { text: 'UespInitData', link: '/pt/api/interfaces/UespInitData' },
              { text: 'UespItemApiData', link: '/pt/api/interfaces/UespItemApiData' },
              { text: 'ChampionPointNode', link: '/pt/api/interfaces/ChampionPointNode' },
              { text: 'SkillSlot', link: '/pt/api/interfaces/SkillSlot' },
            ],
          },
          {
            text: 'Catalog Interfaces',
            collapsed: true,
            items: [
              { text: 'BuffInfo', link: '/pt/api/interfaces/BuffInfo' },
              { text: 'BuffEffect', link: '/pt/api/interfaces/BuffEffect' },
              { text: 'PassiveSkillInfo', link: '/pt/api/interfaces/PassiveSkillInfo' },
              { text: 'ToggleSkillInfo', link: '/pt/api/interfaces/ToggleSkillInfo' },
              { text: 'BuildDebugInfo', link: '/pt/api/interfaces/BuildDebugInfo' },
            ],
          },
          {
            text: 'Type Aliases',
            collapsed: true,
            items: [
              { text: 'EquipSlot', link: '/pt/api/type-aliases/EquipSlot' },
              { text: 'BuffGroup', link: '/pt/api/type-aliases/BuffGroup' },
            ],
          },
        ],
      },
